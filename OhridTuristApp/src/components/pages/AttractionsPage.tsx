...
const allAttractions = [
  {
    ...
    description: "Historic 11th-century church with Byzantine architecture and ancient frescoes."
  },
  {
    id: 2,
    ...
    price: "$15",
    description: "Medieval fortress with panoramic views of Lake Ohrid and the old town."
  },
  {
    id: 3,
    ...
    price: "$25",
    description: "Scenic hiking trails through Galicica National Park with breathtaking mountain views."
  },
  {
    id: 4,
    ...
    price: "$8",
    description: "Prehistoric pile-dwelling settlement reconstruction on the lake."
  },
  {
    id: 5,
    ...
    price: "$5",
    description: "Beautiful monastery complex with peacocks and crystal-clear springs."
  },
  {
    id: 6,
    title: "Old Bazaar",
    ...
    priceKey: "common.free",
    description: "Historic marketplace with traditional crafts and local products."
  }
];
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white shadow-sm px-4 py-3 sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold text-gray-900">{t('featured.title')}</h1>
        </div>
      </div>
            ...
            >
              <div className="relative h-48">
                <ImageWithFallback
                  ...
                  alt={attraction.titleKey ? t(attraction.titleKey) : attraction.title!}
                  className="w-full h-full object-cover"
                />
                <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full text-sm font-medium">
                  {attraction.priceKey ? t(attraction.priceKey) : attraction.price}
                </div>
              </div>
              
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-1">
                  {attraction.titleKey ? t(attraction.titleKey) : attraction.title}
                </h3>
                
                <div className="flex items-center gap-1 mb-2">
                  <MapPin className="h-3 w-3 text-gray-400" />
                  <span className="text-sm text-gray-600">
                    {attraction.locationKey ? t(attraction.locationKey) : attraction.location}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm text-gray-600">
                        {attraction.durationKey ? t(attraction.durationKey) : attraction.duration}
                      </span>
                    </div>
                  </div>
