import { Search, Menu, MapPin, Globe, Settings, Info, HelpCircle, Share, Download, X } from "lucide-react";
  ...
  const handleMenuAction = (action: string) => {
    ...
    switch (action) {
      ...
      case 'help':
        ...
        break;
      case 'about':
        alert('Ohrid Travel Guide v1.0.0\nMade with ❤️ for travelers');
        break;
      case 'share':
        if (navigator.share) {
          navigator.share({
              ...
              <div className="mt-6 space-y-1">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Tell friends about Ohrid</div>
                  </div>
                </button>
